 ...
 * Generated for Laravel 5.7.20 on 2019-01-08 19:38:23.
 *
...
namespace ExinOne\MixinSDK\Facades { 
    ...
    class MixinSDK {
         ...
         * @static 
         */ 
        public static function use($name, $config = array())
        {
            return \ExinOne\MixinSDK\MixinClient::use($name, $config);
        }
        ...
        {
            return \ExinOne\MixinSDK\MixinClient::setConfig($name, $config);
        }
        ...
        {
            return \ExinOne\MixinSDK\MixinClient::getConfig($name);
        }
        ...
        {
            return \ExinOne\MixinSDK\MixinClient::get();
        }
         ...
         * @static 
         */ 
        public static function getOauthUrl($client_id, $scope)
        {
            return \ExinOne\MixinSDK\MixinClient::getOauthUrl($client_id, $scope);
        }
         ...
         * @static 
         */ 
        public static function getPayUrl($asset_id, $amount, $trace_id, $memo, $client_id = null)
        {
            return \ExinOne\MixinSDK\MixinClient::getPayUrl($asset_id, $amount, $trace_id, $memo, $client_id);
        }
...
namespace  { 
    ...
    class MixinClient extends \ExinOne\MixinSDK\Facades\MixinSDK {}
